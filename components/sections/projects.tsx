...
const projects = [
  ...
  },
  {
    ...
    description:
      'An app that helps users create efficient prompts for AI agents with a smoother workflow for drafting, refining, and organizing prompt ideas.',
    ...
    stats: { focus: 'Agents', auth: 'Auth.js', database: 'Neon' },
    comingSoon: false,
  },
  {
    title: 'AI Commercial',
    ...
    description:
      'A commercial project with AI-assisted shopping features, including an AI chatbot for faster product discovery and AI-powered product comparison flows.',
    ...
    image: null,
    stats: { frontend: 'TanStack', backends: '2', ai: 'Shopping' },
    comingSoon: false,
  },
]
